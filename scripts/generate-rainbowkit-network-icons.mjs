...
const manualNetworkIcons = {
  fantom: toDataUri(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" fill="none">
  ...
  moonbeam: toDataUri(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" fill="none">
  ...
  opbnb: toDataUri(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" fill="none">
...
${entries.map(entry => `  ${JSON.stringify(entry.key)}: ${JSON.stringify(entry.url)}`).join(',\n')}
}
